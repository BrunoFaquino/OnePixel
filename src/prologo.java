...
public class prologo extends JFrame {
	...
	private String[] Dialogo = { "Era mais um dia normal no Mundo Virtual.", "Pelo menos, era o que Guri achava...",
		...
		public void run() {
			try {
				...
				for (int z = 0; z < Dialogo[0].length(); z++) {
					TextEffect(Dialogo[0], texto[0], z, 70);
				}
				Thread.sleep(2200);
				...
				for (int z = 0; z < Dialogo[1].length(); z++) {
					TextEffect(Dialogo[1], texto[1], z, 70);
				}
				Thread.sleep(2100);
				...
				for (int z = 0; z < Dialogo[4].length(); z++) {
					TextEffect(Dialogo[4], texto[4], z, 60);
				}
				Thread.sleep(2100);
				...
				for (int z = 0; z < Dialogo[5].length(); z++) {
					TextEffect(Dialogo[5], texto[5], z, 70);
				}
				Thread.sleep(2500);
				...
				for (int z = 0; z < Dialogo[7].length(); z++) {
					TextEffect(Dialogo[7], texto[7], z, 70);
				}
				Thread.sleep(2600);
				...
				for (int z = 0; z < Dialogo[8].length(); z++) {
					TextEffect(Dialogo[8], texto[8], z, 70);
				}
				Thread.sleep(2600);
				...
				for (int z = 0; z < Dialogo[9].length(); z++) {
					TextEffect(Dialogo[9], texto[9], z, 80);
				}
